const features = [
  {
    ...
    description: "Upload bird photos from your phone or computer.",
    icon: (
  ...
  },
  {
    ...
    description: "Tag each photo with its species. Up to 8 photos can be added for each species.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Add any bird species to your personal catalog.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Record details about each shot; location, conditions, behavior, camera equipment and setting, whatever you like!",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function FeaturesSection() {
  return (
    <section className="py-16 sm:py-24 bg-gradient-to-b from-[var(--mist-50)] to-[var(--background)]">
