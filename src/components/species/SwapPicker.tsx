          ...
          return (
            <button
              ...
              className={`relative aspect-square rounded-lg overflow-hidden
                ...
                ${isSelected
                  ? "ring-2 ring-[var(--danger-ring)] ring-offset-1 scale-95"
            ...
            >
              ...
              {isSelected && (
                <div className="absolute inset-0 bg-[var(--danger-from)]/30 flex items-center justify-center">
                  <div className="w-8 h-8 rounded-full bg-[var(--danger-from)] flex items-center justify-center shadow-lg">
              ...
              {photo.isFavorite && (
                <div className="absolute top-1 right-1">
                  <svg className="w-3.5 h-3.5 text-[var(--favorite-color)] drop-shadow" viewBox="0 0 24 24" fill="currentColor">
