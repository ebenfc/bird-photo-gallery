...
export default function AboutPage() {
  ...
  return (
    <div className="pnw-texture min-h-screen pb-24 sm:pb-0">
      ...
      {/* What's New */}
      <Link href="/whats-new" className="block group mb-8">
        <div className="flex items-center justify-between p-4
          bg-[var(--surface-forest)] rounded-[var(--radius-md)]
          border border-[var(--moss-200)] group-hover:border-[var(--moss-300)]
          transition-all duration-[var(--timing-fast)] group-hover:shadow-[var(--shadow-sm)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-[var(--text-primary)] group-hover:text-[var(--moss-700)]
          ...
          <svg className="w-5 h-5 text-[var(--mist-400)] group-hover:text-[var(--moss-600)]
            transition-colors duration-[var(--timing-fast)]"
