...
Detailed history of feature updates and bug fixes.
...
### Security Update (PR #40)

**Updated Next.js to patch security vulnerabilities reported by GitHub Dependabot.**
...
|----------|----------|-------------|
| **High** | GHSA-h25m-26qc-wcjf | HTTP request deserialization can lead to DoS |
| Moderate | GHSA-9g9p-9gw9-jx7f | DoS via Image Optimizer remotePatterns |
| Moderate | GHSA-5f7q-jpqc-wp7h | Unbounded memory consumption via PPR endpoint |
